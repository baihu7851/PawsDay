...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20221024083754_updatelinehistorytype")]
    partial class updatelinehistorytype
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CartId = 1,
                            County = 1,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 493, DateTimeKind.Local).AddTicks(6324),
                            CustomerId = 1,
                            District = 1,
                            ProductId = 1
                        },
                        new
                        {
                            CartId = 2,
                            County = 2,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 493, DateTimeKind.Local).AddTicks(7050),
                            CustomerId = 2,
                            District = 1,
                            ProductId = 3
                        });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.LineBotHistory", b =>
                {
                    ...
                    b.ToTable("LineBotHistory");
                });

            modelBuilder.Entity("ApplicationCore.Entities.LineBotKeyWord", b =>
                {
                    ...
                    b.ToTable("LineBotKeyWord");
                });

            modelBuilder.Entity("ApplicationCore.Entities.LineBotTemplate", b =>
                {
                    ...
                    b.ToTable("LineBotTemplate");
                });

            modelBuilder.Entity("ApplicationCore.Entities.LineBotTemplateDetail", b =>
                {
                    ...
                    b.ToTable("LineBotTemplateDetail");
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            County = 1,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 484, DateTimeKind.Local).AddTicks(2714),
                            District = 1,
                        ...
                        new
                        {
                            ...
                            County = 1,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 485, DateTimeKind.Local).AddTicks(3957),
                            District = 2,
                        ...
                        new
                        {
                            ...
                            County = 2,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 485, DateTimeKind.Local).AddTicks(3989),
                            District = 1,
                        ...
                        new
                        {
                            ...
                            County = 2,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 485, DateTimeKind.Local).AddTicks(3997),
                            District = 2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.PetInfomation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PetId = 1,
                            BirthYear = 2022,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 486, DateTimeKind.Local).AddTicks(1612),
                            Ligation = false,
                            MemberId = 1,
                            PetName = "糖糖",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 2,
                            BirthYear = 2017,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 486, DateTimeKind.Local).AddTicks(1905),
                            Ligation = true,
                            MemberId = 2,
                            PetName = "豆皮",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 3,
                            BirthYear = 2019,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 486, DateTimeKind.Local).AddTicks(1910),
                            Ligation = true,
                            MemberId = 3,
                            PetName = "斑比",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 4,
                            BirthYear = 2018,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 486, DateTimeKind.Local).AddTicks(1913),
                            Ligation = true,
                            MemberId = 4,
                            PetName = "熊熊",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 5,
                            BirthYear = 2019,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 486, DateTimeKind.Local).AddTicks(1915),
                            Ligation = true,
                            MemberId = 4,
                            PetName = "Hippo",
                            PetSex = false,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductId = 1,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1188),
                            EditTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1467),
                        ...
                        {
                            ProductId = 2,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1957),
                            EditTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1961),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 0,
                            ServiceType = 2,
                        ...
                        {
                            ProductId = 3,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1966),
                            EditTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1967),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 1,
                            ServiceType = 3,
                        ...
                        {
                            ProductId = 4,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1971),
                            EditTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1972),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 0,
                            ServiceType = 1,
                        ...
                        {
                            ProductId = 5,
                            CreateTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1976),
                            EditTime = new DateTime(2022, 10, 24, 16, 37, 53, 489, DateTimeKind.Local).AddTicks(1977),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 0,
                            ServiceType = 2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.RegisterSitter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            VerifyTime = new DateTime(2022, 10, 24, 16, 37, 53, 487, DateTimeKind.Local).AddTicks(5987)
                        },
                        new
                        {
                            SitterId = 2,
                            ...
                            SitterName = "溫蒂你好嗎",
                            SitterPicture = "https://raw.githubusercontent.com/Ning0809/FileStorage/801f179b51b3724ec0150c65ccff42b34de88980/pug.jpg",
                            VerifyTime = new DateTime(2022, 10, 24, 16, 37, 53, 487, DateTimeKind.Local).AddTicks(8114)
                        });
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.LineBotTemplateDetail", b =>
                {
                    b.HasOne("ApplicationCore.Entities.LineBotTemplate", "LineBotTemplate")
                        .WithMany("LineBotTemplateDetails")
                        .HasForeignKey("Template")
                        .HasConstraintName("FK_LineBotTemplateDetail_LineBotTemplate")
                        .IsRequired();

                    b.Navigation("LineBotTemplate");
                });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.LineBotTemplate", b =>
                {
                    b.Navigation("LineBotTemplateDetails");
                });
