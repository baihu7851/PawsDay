...
namespace Infrastructure.Data.Migrations
{
    ...
    [Migration("20221009141846_updateorder")]
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Cart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CartId = 1,
                            County = 1,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 465, DateTimeKind.Local).AddTicks(3779),
                            CustomerId = 1,
                            District = 1,
                            ProductId = 1
                        },
                        new
                        {
                            CartId = 2,
                            County = 2,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 465, DateTimeKind.Local).AddTicks(4204),
                            CustomerId = 2,
                            District = 1,
                            ProductId = 3
                        });
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            County = 1,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 459, DateTimeKind.Local).AddTicks(7751),
                            District = 1,
                        ...
                        new
                        {
                            ...
                            County = 1,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(5061),
                            District = 2,
                        ...
                        new
                        {
                            ...
                            County = 2,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(5081),
                            District = 1,
                        ...
                        new
                        {
                            ...
                            County = 2,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(5085),
                            District = 2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.PetInfomation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            PetId = 1,
                            BirthYear = 2022,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(9549),
                            Ligation = false,
                            MemberId = 1,
                            PetName = "糖糖",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 2,
                            BirthYear = 2017,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(9731),
                            Ligation = true,
                            MemberId = 2,
                            PetName = "豆皮",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 3,
                            BirthYear = 2019,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(9735),
                            Ligation = true,
                            MemberId = 3,
                            PetName = "斑比",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 4,
                            BirthYear = 2018,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(9737),
                            Ligation = true,
                            MemberId = 4,
                            PetName = "熊熊",
                            PetSex = false,
                        ...
                        new
                        {
                            PetId = 5,
                            BirthYear = 2019,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 460, DateTimeKind.Local).AddTicks(9738),
                            Ligation = true,
                            MemberId = 4,
                            PetName = "Hippo",
                            PetSex = false,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.Product", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ProductId = 1,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7145),
                            EditTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7316),
                        ...
                        {
                            ProductId = 2,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7600),
                            EditTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7602),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 0,
                            ServiceType = 2,
                        ...
                        {
                            ProductId = 3,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7604),
                            EditTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7605),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 1,
                            ServiceType = 3,
                        ...
                        {
                            ProductId = 4,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7607),
                            EditTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7608),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 0,
                            ServiceType = 1,
                        ...
                        {
                            ProductId = 5,
                            CreateTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7610),
                            EditTime = new DateTime(2022, 10, 9, 22, 18, 45, 462, DateTimeKind.Local).AddTicks(7611),
                            Introduce = "毛小愛Fluv是一個為現代毛爸媽打造的寵物保姆平台APP，使用美國寵物保姆訓練課程和AI數據媒合寵物保姆，所有保姆、美容師、遛狗師等皆有通過「真心愛動物審核」，確保毛小孩會像家人般被對待—一對一、不關籠、全程拍照。為了貫徹我們「愛」的理念，毛小愛同時協助訓練再度中年婦女成為寵物保姆找到再次工作機會和與動物救援機構合作，使用部分營收中途浪浪和協助送養！",
                            IsDelete = false,
                            ProductStatus = 0,
                            ServiceType = 2,
            ...
            modelBuilder.Entity("ApplicationCore.Entities.RegisterSitter", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            VerifyTime = new DateTime(2022, 10, 9, 22, 18, 45, 461, DateTimeKind.Local).AddTicks(8362)
                        },
                        new
                        {
                            SitterId = 2,
                            ...
                            SitterName = "溫蒂你好嗎",
                            SitterPicture = "https://raw.githubusercontent.com/Ning0809/FileStorage/801f179b51b3724ec0150c65ccff42b34de88980/pug.jpg",
                            VerifyTime = new DateTime(2022, 10, 9, 22, 18, 45, 461, DateTimeKind.Local).AddTicks(9505)
                        });
                });
